-- ============================================================
-- AMIKOM EVENT HUB - Database SQL untuk InfinityFree (v2 - Fixed)
-- Database: if0_42217631_db_amikomeventhub3394
-- Host: sql311.infinityfree.com
-- ⚠️  Cara Import: Buka phpMyAdmin InfinityFree → pilih database
--     if0_42217631_db_amikomeventhub3394 → tab Import → pilih file ini
-- ============================================================

SET FOREIGN_KEY_CHECKS = 0;

-- ============================================================
-- DROP semua tabel (urutan: child dulu, baru parent)
-- transactions → events → categories (karena ada FK)
-- ============================================================
...
-- ============================================================
-- Tabel: categories  (parent - dibuat sebelum events)
-- ============================================================
...
-- ============================================================
-- Tabel: events  (child dari categories - dibuat setelah categories)
-- ============================================================
CREATE TABLE `events` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- ============================================================
-- Tabel: transactions  (child dari events - dibuat setelah events)
-- ============================================================
...
-- Seeder: Admin User
-- Login: admin@amikom.ac.id | Password: password
INSERT INTO `users` (`name`, `email`, `email_verified_at`, `password`, `role`, `remember_token`, `created_at`, `updated_at`) VALUES
('Admin Amikom', 'admin@amikom.ac.id', NULL, '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', NULL, NOW(), NOW());
...
-- Seeder: Events (id 1 = Entertaiment, id 2 = Seminar IT)
